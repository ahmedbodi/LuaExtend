...
private:
    ...
    void    RegisteConstants();

    void    CallUpdate(int dt);
    void    CallPause();
    void    CallResume();
	void    CallLuaError(const char * errorstr);
    
    void    OnNetFailed(const char * connectName,int codeId);
